...
import com.example.scholl.service.TrainingProgramService;
...
public class TrainingProgramController {
    ...
    @GetMapping
    public PageResponse<TrainingProgram> list(
        ...
        return service.search(q, majorId, departmentId, activeOnly, pageable);
    }
    ...
    @PostMapping
    public TrainingProgram create(@Valid @RequestBody TrainingProgramRequest request) {
        return service.create(request);
    }

    @PutMapping("/{id}")
    public TrainingProgram update(@PathVariable UUID id, @Valid @RequestBody TrainingProgramRequest request) {
        return service.update(id, request);
    }

    @PatchMapping("/{id}/active")
    public TrainingProgram toggleActive(
